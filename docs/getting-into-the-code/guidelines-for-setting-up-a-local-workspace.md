...
[JavaFX is not part of the default JDK ](https://www.reddit.com/r/java/comments/82qm9x/javafx\_will\_be\_removed\_from\_the\_java\_jdk\_in\_jdk\_11/)anymore, it needs to be installed separately if not using a special JDK.
